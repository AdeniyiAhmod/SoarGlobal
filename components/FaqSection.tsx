    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="container-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
        <div className="lg:sticky lg:top-28">
          ...
          <h2 className="mt-4 max-w-md text-4xl font-black leading-tight tracking-tight text-navy-950 sm:text-5xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            ...
            <ButtonLink href={contact.whatsappHref} variant="light" icon={Send} className="w-full sm:w-auto">
              WhatsApp Us
            </ButtonLink>
          </div>
        </div>
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                <button
                  type="button"
                  className="flex w-full items-center justify-between gap-4 px-5 py-5 text-left text-lg font-bold text-navy-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500 sm:px-6"
                  aria-expanded={open}
